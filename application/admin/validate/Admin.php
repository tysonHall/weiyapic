...
class Admin extends Validate{
	protected $rule = [
		'username'=>'length:1,30|unique:admin|checkDenyMember:',
		'password'=>'length:5,30',
		'email'=>'email|length:1,32|unique:admin',
		'mobile'=>['regex'=>'/^13[0-9]{1}[0-9]{8}$|15[0-9]{1}[0-9]{8}$|18[0-9]{1}[0-9]{8}$|17[0-9]{9}$|147[0-9]{8}$/','unique'=>'admin'],
	];

	protected $message = [
		'username.length'=>'用户名长度不合法',
		'password.length'=>'用户密码长度不合法',
